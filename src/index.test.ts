...
describe('When testing makeSuffix', () => {
  ...
  it('returns the correct ON noun', () => {
    ...
    expect(makeSuffix('phenomenon', randomCount)).toEqual(`${randomCount} phenomena`);
    expect(makeSuffix('criterion', 1)).toEqual('1 criterion');
    expect(makeSuffix('criterion', randomCount)).toEqual(`${randomCount} criteria`);
  });
  it('returns the correct constant + O noun', () => {
    ...
    expect(makeSuffix('tomato', randomCount)).toEqual(`${randomCount} tomatoes`);
  });
  ...
  it('generic tests', () => {
    ...
    expect(makeSuffix('contributor', randomCount)).toEqual(`${randomCount} contributors`);
  ...
  it('odd us and is nouns', () => {
    ...
    expect(makeSuffix('cactus', randomCount)).toEqual(`${randomCount} cactuses`);
    expect(makeSuffix('fungus', 1)).toEqual('1 fungus');
    expect(makeSuffix('fungus', randomCount)).toEqual(`${randomCount} funguses`);
    expect(makeSuffix('stimulus', 1)).toEqual('1 stimulus');
    expect(makeSuffix('stimulus', randomCount)).toEqual(`${randomCount} stimuluses`);
    expect(makeSuffix('syllabus', 1)).toEqual('1 syllabus');
    expect(makeSuffix('syllabus', randomCount)).toEqual(`${randomCount} syllabuses`);
    expect(makeSuffix('analysis', 1)).toEqual('1 analysis');
    expect(makeSuffix('analysis', randomCount)).toEqual(`${randomCount} analyses`);
